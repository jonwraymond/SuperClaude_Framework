...
- **File length**: Not exceed 400 lines (never 1000)
- **Single responsibility**: Each file has one clear purpose
- **Modular design**: Small, focused files in descriptive folders
- **Clear naming**: Descriptive names for files, functions, variables
- **Function size**: Preferably under 50 lines
- **Scalability mindset**: Dependency injection and modular boundaries
- **OOP-first**: Composition over inheritance
- **Manager/coordinator patterns**: Clear separation of concerns

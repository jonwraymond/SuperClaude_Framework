# MODES.md - SuperClaude Framework Operational Modes Reference

Operational modes reference for  SuperClaude Framework framework.
...
Meta-cognitive analysis and SuperClaude Framework framework troubleshooting system.

## Purpose

Meta-cognitive analysis mode that enables  to step outside normal operational flow to examine its own reasoning, decision-making processes, chain of thought progression, and action sequences for self-awareness and optimization.
...
6. **Framework Discussions**: Meta-conversations about SuperClaude Framework components
...
- **Purpose**: Validating actions against SuperClaude Framework framework standards
...
- **Integration**: Seamless SuperClaude Framework framework compliance